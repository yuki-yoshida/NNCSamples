...
上野千鶴子さんの東大入学式祝辞をお手本とすると、出現する文字が687種類もあり、さすがに学習が苦しくなったので、LSTMを使ってみました。Elmanネットの隠れ層をLSTMに移行する方法は、[Sonyの小林さんの講演資料](https://www.slideshare.net/Sony_Neural_Network_Console_Libraries/20180227recurrentneuralnetworks)を参考にさせていただきました。
